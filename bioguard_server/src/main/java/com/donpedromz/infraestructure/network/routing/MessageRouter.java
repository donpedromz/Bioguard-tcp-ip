package com.donpedromz.infraestructure.network.routing;
...
public abstract class MessageRouter {
     ...
     */
    protected HashMap<String, IMessageProcessor> routingTable;
    /**
     ...
     */
    public MessageRouter(HashMap<String, IMessageProcessor> routingTable) {
